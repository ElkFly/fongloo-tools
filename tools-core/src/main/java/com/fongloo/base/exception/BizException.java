...
public class BizException extends BaseUncheckedException {
    ...
    public static BizException wrap(BaseExceptionCode exceptionCode) {
        return new BizException(exceptionCode.getCode(), exceptionCode.getMessage());
    }

    public static BizException validFaild(String message, Object... args) {
